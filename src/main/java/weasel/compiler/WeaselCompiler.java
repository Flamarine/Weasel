...
public class WeaselCompiler implements WeaselClassBuffer {
	...
	private final HashMap<String, WeaselClass> loadedClasses = new HashMap<>();
	private final List<String> toCompile;
	private final HashMap<String, String> sources;
	public List<WeaselClassCompiler> classesToPreCompile = new ArrayList<>();
	public List<WeaselClassCompiler> classesToCompile = new ArrayList<>();
	
	public WeaselCompiler(HashMap<String, String> sources){
		this.sources = sources;
		toCompile = new ArrayList<>(sources.keySet());
	}
